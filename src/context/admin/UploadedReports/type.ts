...
export const APPROVE_REPORT_LOADING = "APPROVE_REPORT_LOADING";
...
export interface APPROVE_REPORT_LOADING_ACTION {
  type: typeof APPROVE_REPORT_LOADING;
  payload: boolean;
}
...
export type UploadedReportAction =
