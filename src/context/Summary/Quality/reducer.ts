...
const reducer: Reducer<QualityState, QualityAction> = (state, action) => {
  switch (action.type) {
    case FETCH_QUALITY_LIST_LOADING:
      return { ...state, listLoading: action.payload };
    case FETCH_QUALITY_LIST_SUCCESS:
      return { ...state, listData: action.payload };
    case FETCH_QUALITY_STATS_LOADING:
      return { ...state, statsLoading: action.payload };
    case FETCH_QUALITY_STATS_SUCCESS:
      return { ...state, statsData: action.payload };
    case FETCH_QUALITY_PENDING_LOADING:
      return { ...state, pendingLoading: action.payload };
    case FETCH_QUALITY_PENDING_SUCCESS:
      return { ...state, pendingData: action.payload };
    case SET_QUALITY_PAGE:
