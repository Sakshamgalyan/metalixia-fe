    ...
    <>
      ...
      <div className="grid grid-cols-7 gap-1 mb-2">
        {weekDays.map((day) => (
          <div
            key={day}
            className="text-center text-xs font-semibold uppercase text-slate-400 py-1"
          >
            {day}
          </div>
        ))}
              ...
              <div className="flex items-center justify-between border-t border-slate-200 pt-4 mt-2">
                ...
                <div className="flex items-center gap-1 bg-slate-50 border border-slate-200 p-1 rounded-lg">
                  <Dropdown
                    ...
                    dropdownWidth={80}
                  />
                  <span className="text-slate-400 font-bold -mx-1 -mt-0.5">
                    :
                  </span>
                  <Dropdown
                    value={minute}
                  ...
                  <Dropdown
                    ...
                    onChange={(val) => {
                      ...
                      setPeriod(p);
                      if (selectedDate)
                        handleTimeChangeInternal(hour, minute, p, selectedDate);
                    }}
                    size="xs"
                    variant="inline"
                    className="w-16"
