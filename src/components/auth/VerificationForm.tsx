    ...
    return (
        ...
        >
            <div className="mb-6 text-center">
                ...
                <Typography variant="p" weight="normal" textColor="#5a67ba" className="text-xs mt-2">
                    We've sent a 6-digit code to <br />
                    <span className="font-semibold text-slate-700">{user?.email || "your email"}</span>
                </Typography>
            </div>
                ...
                <div className="flex items-center justify-center">
                    {timer > 0 ? (
                        <p className="text-sm text-slate-500">
                            Resend code in <span className="font-medium text-slate-700">{timer}s</span>
                        </p>
                    ) : (
                        <Button
                            variant="link"
