...
import { Layers, IndianRupee, Truck, Calendar, ArrowUpRight } from "lucide-react";
            ...
            >
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex items-center gap-1.5 mt-2">
                            <div className="flex -space-x-2">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="w-5 h-5 rounded-full border-2 border-white bg-violet-100 flex items-center justify-center">
                                        <div className="w-1 h-1 rounded-full bg-violet-600" />
                                    </div>
                                ))}
                            </div>
                            <span className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">Active Inventory</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="h-16 mt-2 relative">
                    {!statsLoading && dailyCounts.length > 0 ? (
                        ...
                        <div className="absolute inset-0 flex items-center justify-center text-[10px] text-slate-300 uppercase tracking-widest">Calculating trends...</div>
                    )}
                </div>
            </motion.div>
                ...
                <div className="p-6">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex items-center gap-1.5 mt-2">
                             ...
                             <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Verified Sources</span>
                        </div>
                    </div>
                </div>
