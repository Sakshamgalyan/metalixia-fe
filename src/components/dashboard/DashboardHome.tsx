...
const DashboardHome = () => {
  ...
  const activities = [
    { id: 1, type: "System", message: "Automated backup completed successfully.", time: "10 min ago", status: "success" },
    { id: 2, type: "Security", message: "Door 4A forced open alert cleared.", time: "45 min ago", status: "warning" },
    { id: 3, type: "Production", message: "Line B maintenance schedule created.", time: "2 hours ago", status: "info" },
    { id: 4, type: "Employee", message: "Shift A check-in completed.", time: "4 hours ago", status: "success" },
  ];
  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto">
      ...
      >
        <Typography variant="h2" className="text-slate-900 font-black">Factory Overview</Typography>
          ...
          >
            ...
            <div className="relative p-6">
              <div className="flex justify-between items-start mb-5">
                ...
                <div className={`flex items-center gap-1 text-xs font-bold px-2 py-1 rounded-lg ${stat.trendBg} ${stat.trendText}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="relative p-6">
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <Typography variant="h5" className="text-slate-800 font-bold">Production Efficiency</Typography>
                </div>
              ...
              <Chart
                data={[65, 59, 80, 81, 56, 55, 40, 70, 75, 50, 60, 90, 85, 95, 100, 80, 70, 60, 50, 40, 55, 65, 75, 85]}
                height={300}
                type="area"
                color="#707FDD"
                showGridLines
            ...
            <div className="relative bg-[#111827] rounded-2xl overflow-hidden shadow-[0_4px_30px_rgba(0,0,0,0.15)] group">
              ...
              <div className="relative p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <Typography variant="h6" className="text-white font-semibold text-sm">
                    Outbound Logistics
                  </Typography>
                </div>
        ...
        >
          ...
          <div className="relative p-6">
            <Typography variant="h5" className="mb-6 flex items-center gap-2.5 text-slate-800 font-bold">
